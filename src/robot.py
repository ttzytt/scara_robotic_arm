...
from src.consts import ur, pqt
from src.kinematics import ParaScaraSetup, ParaScaraState
...
def _get_default_robot() -> Robot: 
    ...
    arm = Arm(arm_steup, lf_step_motor, rt_step_motor)
